        ...
        render={({ field, fieldState: { error } }) => (
          <div className="flex flex-col justify-center w-full">
            ...
            <Form.Item style={{ marginBottom: "0px" }}>
              ...
              id={name}
              size="large"
              className={cn("w-full placeholder:!text-text-secondary font-poppins", readOnly && "cursor-not-allowed", inputClassName)}
              placeholder={placeHolder}
              readOnly={readOnly}
            />
              }
            ...
            {error && <small className="mt-1" style={{ color: "red" }}>{error.message}</small>}
          </div>
        )}
      />
    </div>
